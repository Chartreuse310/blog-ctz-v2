...
> ——0xfe / Mohit Muthanna Cheppudira（VexTab的作者）

## VexTab基本语法

我不知道"语法"这个表述是否合适，但懂我意思就行。
...
使用 **音符/八度**（note/octave） 加上 `#` `@` `n` 来表示音符，以中央C为例，表示为 C/4<sup><a href="#fn-3" id="fnref-3">[3]</a></sup>：
...
直接用 text 添加文本<sup><a href="#fn-4" id="fnref-4">[4]</a></sup>：
...
常用参数<sup><a href="#fn-5-7" id="fnref-5-7-1">[5-7]</a></sup>：
...
外观相关参数表<sup><a href="#fn-5-7" id="fnref-5-7-2">[5-7]</a></sup>：
...
词汇表<sup><a href="#fn-5-7" id="fnref-5-7-3">[5-7]</a></sup>：
...
较复杂的组合<sup><a href="#fn-8" id="fnref-8">[8]</a></sup>：
...
<div class="footnotes">
  <p id="fn-1">[1] Obsidian Vextab 插件 GitHub仓库：<a href="https://github.com/luigman/obsidian-vextab">https://github.com/luigman/obsidian-vextab</a> <a href="#fnref-1" class="fn-back">↩</a></p>
  <p id="fn-2">[2] 52cmajor网站的在线编辑器：<a href="https://www.52cmajor.com/tab/editor">https://www.52cmajor.com/tab/editor</a> <a href="#fnref-2" class="fn-back">↩</a></p>
  <p id="fn-3">[3] 注意，由于默认显示tab谱，所以需要加上 <code>notation=true tablature=false</code> 才能仅显示五线谱。 <a href="#fnref-3" class="fn-back">↩</a></p>
  <p id="fn-4">[4] 这个例子来源于 <a href="https://yedaxia.github.io/VexTab-Introdution/">叶大侠的文章</a>。 <a href="#fnref-4" class="fn-back">↩</a></p>
  <p id="fn-5-7">[5-7] 参考 <a href="https://yedaxia.github.io/VexTab-Introdution/">叶大侠的文章</a>。 <a href="#fnref-5-7-1" class="fn-back">↩</a></p>
  <p id="fn-8">[8] 这个例子来源于 <a href="https://yedaxia.github.io/VexTab-Introdution/">叶大侠的文章</a>。 <a href="#fnref-8" class="fn-back">↩</a></p>
</div>
